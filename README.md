...
| **06** | The Attention Mechanism                 | ✅ Complete | [Medium](https://soloshun.medium.com/building-llms-from-scratch-part-6-the-attention-mechanism-b7ffc18c0dae)                  | [Code](./src/part06_attention_mechanism.py)         |
| **07** | Self-Attention with trainable weights   | ✅ Complete | [Medium](https://soloshun.medium.com/building-llms-from-scratch-part-7-self-attention-with-trainable-weights-641035115cc6)    | [Code](./src/part07_self_attention_with_weights.py) |
| **08** | Casual Attention                        | ✅ Complete | [Medium](https://medium.com/@soloshun/building-llms-from-scratch-part-8-causal-attention-6e4a0578c88c)                        | [Code](./src/part08_causal_attention.py)            |
| **09** | Multi-Head Attention                    | ✅ Complete | [Medium](https://soloshun.medium.com/building-llms-from-scratch-part-9-multi-head-attention-ea3f3629bc6b)                     | [Code](./src/part09_multi_head_attention.py)        |
| **0-** | Bird's Eye View of the LLM Architecture | ⏳ Planned  | [Medium](.)                                                                                                                   | [Code](./src/)                                      |
