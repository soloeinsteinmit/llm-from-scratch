...
| **0-** | Self-Attention with trainable weights  | ✅ In Complete | [Medium](https://soloshun.medium.com/building-llms-from-scratch-part-7-self-attention-with-trainable-weights-641035115cc6)    | [Code](./src/part07_self_attention_with_weights.py) |
| **0-** | Casual Attention                       | 🔄 In progress | [Medium](.)                                                                                                                   | [Code](./src/)                                      |
